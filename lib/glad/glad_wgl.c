/*
    ...
    WGL loader generated by glad 0.1.34 on Mon Aug 21 13:59:42 2023.
    ...
    Commandline:
        --api="wgl=1.0" --generator="c" --spec="wgl" --no-loader --local-files --extensions="WGL_ARB_create_context,WGL_ARB_create_context_profile,WGL_ARB_extensions_string,WGL_EXT_extensions_string"
    Online:
        https://glad.dav1d.de/#language=c&specification=wgl&api=wgl%3D1.0&extensions=WGL_ARB_create_context&extensions=WGL_ARB_create_context_profile&extensions=WGL_ARB_extensions_string&extensions=WGL_EXT_extensions_string
*/
